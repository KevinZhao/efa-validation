#!/bin/bash
# DeepSeek-V4-Flash decode entrypoint — mirrors customer's Kimi-K2.5 decode entrypoint 1:1
# except: parser / reasoning / model
set -e
...
echo "[launcher] starting sglang decode (Kimi-K2 1P1D repro of customer K2.5 segfault)"
